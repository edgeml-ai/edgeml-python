...
def init(
    ...
    resolved_key = api_key or _os.environ.get("OCTOMIL_API_KEY", "")
    resolved_org = org_id or _os.environ.get("OCTOMIL_ORG_ID", "default")
    resolved_base = api_base or _os.environ.get(
        "OCTOMIL_API_BASE", "https://api.octomil.io/api/v1"
    )
