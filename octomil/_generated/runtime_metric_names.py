...
AUDIO_FEATURE_REUSE_TOTAL = "audio.feature_reuse_total"
CACHE_AUDIO_PHONEME_HIT_RATE = "cache.audio.phoneme.hit_rate"
CACHE_AUDIO_PHRASE_HIT_RATE = "cache.audio.phrase.hit_rate"
CACHE_AUDIO_VOICE_HIT_RATE = "cache.audio.voice.hit_rate"
CACHE_BYTES = "cache.bytes"
CACHE_DISABLED_TOTAL = "cache.disabled_total"
CACHE_EVICTION_TOTAL = "cache.eviction_total"
CACHE_HIT_TOTAL = "cache.hit_total"
CACHE_LOOKUP_MS = "cache.lookup_ms"
CACHE_MISS_TOTAL = "cache.miss_total"
CACHE_ROUTE_HIT_RATE = "cache.route.hit_rate"
EMBEDDINGS_CACHE_HIT_TOTAL = "embeddings.cache_hit_total"
GPU_ACTIVE_PCT = "gpu.active_pct"
GPU_POWER_W = "gpu.power_w"
KV_PREFIX_BYTES = "kv_prefix.bytes"
KV_PREFIX_CACHE_HIT = "kv_prefix.cache_hit"
KV_PREFIX_CACHE_HIT_RATE = "kv_prefix.cache_hit_rate"
KV_PREFIX_CACHE_MISS = "kv_prefix.cache_miss"
KV_PREFIX_SAVED_TOKENS = "kv_prefix.saved_tokens"
KV_PREFIX_SAVED_TOKENS_TOTAL = "kv_prefix.saved_tokens_total"
MIMI_FRAMES_DROPPED_TOTAL = "mimi.frames_dropped_total"
MIMI_FRAMES_ENCODED_TOTAL = "mimi.frames_encoded_total"
MODEL_EVICT_COUNT_TOTAL = "model.evict_count_total"
MODEL_LOAD_MS = "model.load_ms"
MODEL_WARM_MS = "model.warm_ms"
SCHEDULER_PREEMPT_COUNT_TOTAL = "scheduler.preempt_count_total"
SCHEDULER_QUEUE_DEPTH = "scheduler.queue_depth"
SPEAKER_AUDIO_DURATION_MS = "speaker.audio_duration_ms"
SPEAKER_CACHE_HIT_TOTAL = "speaker.cache_hit_total"
SPEAKER_INFERENCE_MS = "speaker.inference_ms"
SPEAKER_SETUP_MS = "speaker.setup_ms"
STT_VAD_GATED_MS_SAVED = "stt.vad_gated_ms_saved"
TTS_AUDIO_CACHE_HIT_TOTAL = "tts.audio_cache_hit_total"
TTS_AUDIO_CACHE_MISS_TOTAL = "tts.audio_cache_miss_total"
TTS_AUDIO_DURATION_MS = "tts.audio_duration_ms"
...
VAD_AUDIO_DURATION_MS = "vad.audio_duration_ms"
VAD_INFERENCE_MS = "vad.inference_ms"
...
WHISPER_SESSION_OPEN_MS = "whisper.session_open_ms"
