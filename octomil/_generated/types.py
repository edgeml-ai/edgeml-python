...
class CreatePublishableKeyRequest(BaseModel):
    ...
    environment: Environment | None = "live"
...
class CloudRoutingStrategy1(Enum):
    ordered_failover = "ordered_failover"
    weighted_shuffle = "weighted_shuffle"
    least_busy = "least_busy"
...
class UpdateRoutingResponse(BaseModel):
    ...
    cloud_routing_strategy: CloudRoutingStrategy1
...
class ExecutionHealthResponse(BaseModel):
    ...
    targets: List[Target]
    strategy: CloudRoutingStrategy1
...
class UpdateCloudPolicyRequest(BaseModel):
    ...
    cloud_credential_policy: CloudCredentialPolicy | None = None
...
class CloudPolicyResponse(BaseModel):
    ...
    cloud_credential_policy: CloudCredentialPolicy1 = Field(
...
class ApiKeyResponse(BaseModel):
    ...
    scopes: Dict[str, bool]
    is_active: bool
    environment: Environment4 | None = None
    app_id: str | None = None
    allowed_app_ids: List[str] | None = None
    allowed_origins: List[str] | None = None
...
class CandidateGateSchema(BaseModel):
    ...
    code: Code = Field(..., description="Gate code identifying the check to perform.")
    required: bool = Field(
        ...,
...
class ExperimentTargetGroups(BaseModel):
    ...
    experiment_id: str
    target_groups: List[TargetGroup] = Field(..., description="Empty array when no groups are configured.")
...
class Experiment(BaseModel):
    ...
    target_groups: List[TargetGroup1] | None = Field(
        None,
...
class ExperimentSequentialAnalysis(BaseModel):
    pass
    model_config = ConfigDict(
        extra="allow",
    )
...
class Guardrail(BaseModel):
    ...
    metric_name: str | None = None
    status: Status8 | None = Field(None, description="pass = guardrail held; violation = threshold breached.")
...
class AudioSpeechRequest(BaseModel):
    ...
    response_format: Format | None = Field(
        "wav",
...
class AgentManifest(ExperimentSequentialAnalysis):
    pass
...
class ExecutionConfigResponse(BaseModel):
    ...
    routing_strategy: CloudRoutingStrategy1
    cooldown_seconds: int = Field(..., ge=0)
...
class DeviceRuntimeProfileSchema(BaseModel):
    ...
    supported_gate_codes: List[Code] | None = Field(
        None,
