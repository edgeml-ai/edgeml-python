...
configuration for local LLM inference across engines (octomil serve,
...
from octomil.hardware import HardwareProfile
...
class ModelOptimizer:
    ...
    Engine-agnostic: works with octomil serve, Ollama, llama.cpp, and other
    ...
    def serve_command(
        ...
        Args:
            ...
            engine: Override engine. ``None`` (default) auto-detects from PATH.
                Explicit values: ``"octomil"``, ``"ollama"``, ``"llama.cpp"``.
        """
        ...
        return self._octomil_command(model_tag, config)

    @staticmethod
    def _octomil_command(model_tag: str, config: QuantOffloadResult) -> str:
        parts = ["octomil", "serve", model_tag]
