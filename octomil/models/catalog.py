...
The catalog is now powered by the v2 manifest endpoint via
:class:`~octomil.models.catalog_client.CatalogClientV2`. Manifest
models and packages are converted to the legacy ``ModelEntry`` /
``VariantSpec`` format for backward compatibility.
"""
