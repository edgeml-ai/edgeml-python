...
Replaces the v1 multi-endpoint clients (CatalogClient, EnginePriorityClient,
ModelFamiliesClient, SourceAliasesClient) with a single ``CatalogClientV2``
that fetches the complete manifest from ``GET /api/v2/catalog/manifest``.
