...
class ModelRegistry:
    ...
    def download(
        ...
        *,
        ...
        checks the ``OCTOMIL_DEVICE_TYPE`` environment variable for
        ...
        Args:
            ...
            device_type: Device profile key (e.g. ``REDACTED_DEVICE``).
        ...
        ios_devices = {"REDACTED_DEVICE", "REDACTED_DEVICE"}
    ...
    def optimize(
        ...
        Args:
            model_id: Model identifier.
            target_devices: Target device profiles (e.g. ["REDACTED_DEVICE", "pixel_8"]).
    ...
    def get_device_config(
        ...
        Args:
            model_id: Model identifier.
            device_type: Device profile key (e.g. "REDACTED_DEVICE", "pixel_8").
